...
import { ICsStatusListDto, IDefaultResponseDto, IMyAwardCs } from '../event.interface';
import { CsItemListPopupComponent } from '../components/cs-item-list-popup/cs-item-list-popup.component';
import { CsLinesComponent } from './cs-lines/cs-lines.component';
import { FilterComponent } from 'src/app/shared/components/filter/filter.component';
@Component({
  selector: 'app-my-award-cs',
  templateUrl: './my-award-cs.component.html',
  styleUrls: ['./my-award-cs.component.scss'],
})
export class MyAwardCsComponent {
  columnWidth = 150;
    ...
    this.eventService.getMyAwardCs(payload).subscribe({
      next: (result: IDefaultResponseDto<IMyAwardCs[]>) => {
        if (result.success) {
          ...
          // this.gridView = process(this.CsLinesComponent, this.state);
