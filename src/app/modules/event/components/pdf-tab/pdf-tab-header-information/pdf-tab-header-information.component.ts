...
import { ComparisonVendorParam, IDefaultResponseDto, IRfqDetailDataDto, IVendorBidComparison, IheaderBidComparision } from '../../../event.interface';
...
@Component({
  selector: 'app-pdf-tab-header-information',
  templateUrl: './pdf-tab-header-information.component.html',
  styleUrls: ['./pdf-tab-header-information.component.scss']
})
export class PdfTabHeaderInformationComponent {
