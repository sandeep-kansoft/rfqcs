...
@Component({
  selector: 'app-vendor-analysis-line-item-information',
  templateUrl: './vendor-analysis-line-item-information.component.html',
  styleUrls: ['./vendor-analysis-line-item-information.component.scss'],
})
export class VendorAnalysisLineItemInformationComponent {
