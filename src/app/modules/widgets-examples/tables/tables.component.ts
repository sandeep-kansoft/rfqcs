...
import { ModifierKey, MultipleSortSettings, GridDataResult } from '@progress/kendo-angular-grid';
...
export class TablesComponent implements OnInit {
  ...
  public sort: SortDescriptor[] = [{ field: "ProductID", dir: "asc" }];
  ...
  public loadData(): void {
    this.gridData = filterBy(products, this.filter);
  ...
  public onRadioChange(e: Event) {
    const inputTarget = e.target as HTMLInputElement;
    this.sortSettings.multiSortKey = inputTarget.value as ModifierKey;
  }
